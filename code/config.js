export let methodsCanvas = document.getElementById('methods');
export let localCanvas = document.getElementById('local-error');

export let variant = 11;
export let gridNum = 50;
